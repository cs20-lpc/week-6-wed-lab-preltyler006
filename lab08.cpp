...
unsigned fact(unsigned, unsigned acc = 1);
unsigned fib(unsigned, unsigned a = 0, unsigned b = 1);
unsigned mult(unsigned, unsigned, unsigned acc = 0);
unsigned power(unsigned, unsigned, unsigned acc = 1);
unsigned product(unsigned, unsigned, unsigned acc = 1);
